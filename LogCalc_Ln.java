...
public class LogCalc_Ln extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_ln);
    ...
    private void formatOutput() {
    	...
    	output.setText(Html.fromHtml("ln(" + value + ") = " + df.format(Math.log(value.doubleValue())) + "\n\n"));
    }
    ...
    private void showHelpMenu() {
        	helpMenu = new AlertDialog.Builder(LogCalc_Ln.this)
    		.setTitle("Help")
    		.setCancelable(true)
    		.setNeutralButton("Okay", null)
    		.create();
        	helpMenu.setMessage("ln x - use this to solve a natural logarithm (log base e)" +
